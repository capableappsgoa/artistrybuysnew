...
export default function Productmapped(item) {
    return (
        <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div className="h-56 w-full">
                <img className="mx-auto h-full dark:hidden" src={item.image} alt="" />
                <img className="mx-auto hidden h-full dark:block" src={item.image} alt="" />
            </div>
            <div className="pt-6">
                <div className="mb-4 flex items-center justify-between gap-4">
                    <span className="me-2 rounded bg-primary-100 px-0.5 py-0.5 text-xs font-medium text-primary-800 dark:bg-primary-900 dark:text-primary-300">{item.category}</span>
                ...
                <div className="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">
                    {item.title.length > 10 ? `${item.title.slice(0, 22)}...` : item.title}
                </div>
                ...
                <div className="mt-4 flex items-center justify-between gap-4">
                    ...
                    <button type="button" className="inline-flex items-center rounded-lg bg-[blue] px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
